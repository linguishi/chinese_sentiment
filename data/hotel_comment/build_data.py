...
if __name__ == '__main__':
    ...
    build_data_file(pos_dir, pos_samples[0:num_pos // 5], 'POS', 'train')
    build_data_file(pos_dir, pos_samples[num_pos // 5:], 'POS', 'eval')
    build_data_file(neg_dir, neg_samples[0:num_neg // 5], 'NEG', 'train')
    build_data_file(neg_dir, neg_samples[num_neg // 5:], 'NEG', 'eval')